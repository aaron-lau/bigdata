 ...
 */
public class PageRankMultiSourceNode implements Writable {
  ...
  public PageRankMultiSourceNode() {}

  public float getPageRank(int index) {
    return pagerank.get(index);
  }

  public ArrayListOfFloatsWritable getAllPageRanks(){
      return pagerank;
  }
  ...
  public String toString() {
    return String.format("{%d %.4f %s}", nodeid,
    (pagerank == null ? "[]" : pagerank.toString(20)),
   ...
   * @throws IOException if any exception is encountered during object deserialization
   */
  public static PageRankMultiSourceNode create(DataInput in) throws IOException {
    PageRankMultiSourceNode m = new PageRankMultiSourceNode();
    m.readFields(in);
   ...
   * @throws IOException if any exception is encountered during object deserialization
   */
  public static PageRankMultiSourceNode create(byte[] bytes) throws IOException {
